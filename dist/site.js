...
var $ = __webpack_require__(0);
var chords_lib_1 = __webpack_require__(8);
var chords_1 = __webpack_require__(1);
var cookies_1 = __webpack_require__(2);
        ...
        if (options.chordsViewSelector) {
            ...
            song.chords.forEach(function (chordName) {
                ...
                if (accord != null) {
                    ...
                    $("<chord name=\"" + accord.name + "\" positions=\"" + accord.positions + "\" " + fingers + " size=\"2\"/>").appendTo($chordsView_1);
                }
            });
